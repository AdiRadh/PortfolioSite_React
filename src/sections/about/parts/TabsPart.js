...
class TabsPart extends React.Component {
    ...
    render() {
        ...
        return ( <
            ...
            TabSelectors >
            <
            TabSelector className = { this.state.tab === "languages" ? "active" : "" }
            onClick = {
                () => this.setState({ tab: "languages" }) } >
            Languages <
            /TabSelector> <
            TabSelector className = { this.state.tab === "technologies" ? "active" : "" }
            onClick = {
                () => this.setState({ tab: "technologies" }) } >
            Technologies <
            /TabSelector> <
            ...
            Timeline data = {
                {
                    "2020 - Current": {
                        ...
                        institution: "Prizelogic",
                        description: "Worked as lead Backend developer on high profile web applications and API's for online engangements. Created and managed site flows, third-party and internal integrations, and data storage and reporting. Maintained and improved existing internal processes and applications, and helped train new hires. Tech Stack: .NET, .NET Core, C#, Azure Cloud, Azure Function Applications, Azure DevOps, Git"
                    },
                    "2019 - 2020": {
